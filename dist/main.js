        ...
        */
                ...
                if (cardAndColumnWhoWantsThisOtherCards.element) {
                    ...
                    if (cardAndColumnWhoWantsThisOtherCards.element.classList.contains("special")) {
                        ...
                        console.log("TUTAJ :", columnWitchGetCards.getCardsBelow(0)[0].offsetLeft, columnWitchGetCards.getCardsBelow(0)[0].offsetTop);
                        newPosition = {
                    ...
                    instantCards.forEach((c, i) => c.setPosition({
                        x: newPosition.x,
    ...
    forSelection.forEach((element) => {
        element.addEventListener("click", (e) => {
            if (element.classList.contains("invisible")) {
                ...
                lastCard === null || lastCard === void 0 ? void 0 : lastCard.element.classList.remove("invisible");
                lastCard === null || lastCard === void 0 ? void 0 : lastCard.element.classList.add("visible");
